...
def tpl_detection_fast_annoy(tar_fcg_path, cdd_fcg_path, func_path, feature_save_path, area_save_path, time_path, tar_in9_embedding_json_path, cdd_in9_embedding_json_path, sim_funcs_path, obj_func_embeddings_path, cdd_func_embeddings_path, gnn_model_path, tar_afcg_path, cdd_afcg_path, tar_subgraph_path, cdd_subgraph_path):
    cal_time = {}
    # object_item_list_temp = []
    object_item_list = os.listdir(func_path)
    ...
    # object_cdd_func_dict = json.load(open(os.path.join(func_path, object_item), "r"))
    # cdd_project_dict = get_cdd_func_dict(object_cdd_func_dict)
    obj_com_funcs_file = json.load(open(tar_in9_embedding_json_path)).keys()
    cdd_com_funcs_file = json.load(open(cdd_in9_embedding_json_path)).keys()
